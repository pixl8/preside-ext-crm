...
<cfscript>
	...
	recordLabel = renderLabel( "contact", args.record_id );
	recordUrl   = event.buildAdminLink( linkTo="contactManager.edit", queryString="id=#args.record_id#" );
	recordLink  = '<a href="#recordUrl#">#recordLabel#</a>';

	message = translateResource( uri="auditlog.contactmanager:#args.action#.message", data=[ userLink, recordLink ] );
</cfscript>

...
<cfoutput>
	<div class="top-right-button-group">
		<cfif canAdd>
			<a class="pull-right inline" href="#event.buildAdminLink( linkTo="personManager.add" )#" data-global-key="a">
	...
	#renderView( view="/admin/datamanager/_objectDataTable", args={
		...
		, datasourceUrl       = event.buildAdminLink( linkTo="personManager.getRecordsForAjaxDataTables" )
